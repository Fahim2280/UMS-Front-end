...
export default function AdminDashboard() {
    ...
    <br></br>
    <br></br>
    <Link href="/admin/dashboard/addfaculty">Add Faculty</Link>
    <br></br>
    <br></br>
    <Link href="/admin/dashboard/addcourse">Add Course</Link>
    <br></br>
    <br></br>
    <Link href="/admin/dashboard/updatestudent">UPdate student</Link>
    <br></br>
    <br></br>
    <Link href="/admin/dashboard/updatefaculty">UPdate Faculty</Link>
    <br></br>
    <br></br>
    <Link href="/admin/dashboard/updateofficer">UPdate Officer</Link>
    <br></br>
    <br></br>
